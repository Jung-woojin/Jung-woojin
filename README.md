...
<img src="https://skillicons.dev/icons?i=python,pytorch,opencv,numpy,pandas,jupyter,git,linux&theme=light" />

<br/>

![YOLO](https://img.shields.io/badge/YOLO-Ultralytics-0EA5E9?style=flat-square&logo=ultralytics&logoColor=white)
![Manim](https://img.shields.io/badge/Manim-Animation-F97316?style=flat-square&logo=manim&logoColor=white)
...
### 🔬 Research Interests
- **CNN Architecture Design**: Novel convolutions, efficient bottlenecks
- **Signal-Aware Convolutions**: Fourier-based, Wavelet-based kernels
- **Effective Receptive Field (ERF)**: Understanding and optimizing receptive fields
- **Object Detection**: Real-time, high-accuracy detection systems
- **Vision-Language Models**: Open-vocabulary detection, zero-shot learning

### 🚀 Career Objectives
1. **Design**: Create my own object detection architecture
2. **Research**: Publish at top venues (CVPR, ICCV, ECCV)
3. **Application**: Real-world deployment on edge devices
...
- 🎯 **Object Detection**: Complete tutorial series on YOLO, DETR variants
- 📊 **IoU Variants**: Detailed comparison and implementation guide
- 🔬 **Loss Functions**: Analysis of CIoU, SIoU, GIoU, EIoU, WIoU

**Community Engagement**
- 📚 Comprehensive documentation for object detection
- 🎬 Educational visualizations with Manim
- 📝 Regular updates on CVPR research trends
